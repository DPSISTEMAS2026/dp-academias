/** Divisiones IBJJF con gi, en español. Identidad DP. */
...
function pickDivision(weight, cuts, overflow) {
...
export function calculateIBJJFCategory(birthDate, weightKg, gender, beltStr = 'WHITE') {
  let age = 0;
  if (birthDate) {
